define(["three", "geometry", "shader!terrain.vert", "shader!terrain.frag", "shader!terrainSnow.frag", "shader!terrainToon.frag", "texture", "scene", "camera"], function (THREE, geometry, terrainVert, terrainFrag, terrainSnowFrag, terrainToonFrag, texture, scene, camera) {
  ...
  Terrain.prototype.createTile = function (x, y, scale, edgeMorph) {
    var terrainMaterial = this.createTerrainMaterial(this.heightData,
      ...
      this.resolution,
      edgeMorph);
    //    console.log(terrainMaterial.uniforms.uGlobalOffset.value);
