...
//var windowW = $('#canvas5').innerWidth() / 2;
//var windowH = $('#canvas5').innerHeight() / 2;
var windowW;
var windowH;
/** DPIです。 */
...
function init() {
  ...
  windowW = $('#canvas5').innerWidth() / 2;
  windowH = $('#canvas5').innerHeight() / 2;
  // 重力の設定
...
function createPixiWorld() {
  ...
  canvas5.insertBefore(app.view, canvas5.firstChild);
  //  $('canvas5').append(app.view);
  //  $("#myCanvas5").append(app.view);
  stage = app.stage;
