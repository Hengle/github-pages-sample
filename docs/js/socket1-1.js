...
window.addEventListener('load', socket1_1);
...
function socket1_1() {
  ...
  //  function animate() {
  tickObj.tick2 = function () {
    if (video.readyState === video.HAVE_ENOUGH_DATA) {
      videoTexture.needsUpdate = true;
      getZDepths();
    }
    stats.update();
    requestAnimationFrame(tickObj["tick2"]);
    render();
  }
...
//
//  function animate() {
//    //  tickObj.tick3 = function () {
//    if (video.readyState === video.HAVE_ENOUGH_DATA) {
//      videoTexture.needsUpdate = true;
//      getZDepths();
//    }
//    stats.update();
//    //    callbackId = requestAnimationFrame(tickObj["tick3"]);
